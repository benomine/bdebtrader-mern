...
export default function CryptoDashboard() {
    ...
    const getDailyPriceHistory = async () => {
        try {
            await Axios({
                method: 'post',
                url: 'http://localhost:3001/api/protected/vantage-api/getHistory',
                headers: {
                    'Authorization': localStorage.getItem('jwt'),
                },
                data: {
    ...
    const getHealthIndex = async () => {
        try {
            await Axios({
                method: 'post',
                url: 'http://localhost:3001/api/protected/vantage-api/getCryptoRating',
                headers: {
                    'Authorization': localStorage.getItem('jwt'),
                },
                data: {
    ...
    const getExchangeRate = async () => {
        try {
            await Axios({
                method: 'post',
                url: 'http://localhost:3001/api/protected/vantage-api/getExchangeRate',
                headers: {
                    'Authorization': localStorage.getItem('jwt'),
                },
                data: {
