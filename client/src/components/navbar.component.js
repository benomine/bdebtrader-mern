...
export default function Login(props) {
    ...
    return (
        <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark" className="nav-bar"> 
            <Navbar.Brand href={props.isAuthenticated? "/app":"/"}>BdebTrader</Navbar.Brand>
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
                <Nav className="mr-auto">
                   ...
                   {props.isAuthenticated&& <Link to="/crypto" className="nav-link">Crypto Currencies</Link>}
                   {props.isAuthenticated&& <Link to="/symbols" className="nav-link">Symbols</Link>}
