...
export default function ExpenseTracker() {
    ...
    const readTransactions = async () => {
        ...
        await Axios({
            method: 'get',
            url: 'http://localhost:3001/api/protected/income//getHistory',
            headers: {
                'Authorization': localStorage.getItem('jwt'),
            },
        }).then(res => {
    ...
    const onSubmit = async (e) => {
        try {
            ...
            await Axios({
                method: 'post',
                url: 'http://localhost:3001/api/protected/income/addTransaction',
                headers: {
                    'Authorization': localStorage.getItem('jwt'),
                },
                data: {
    ...
    const deletetransaction = async (id) => {
        await Axios({
          method: 'delete',
          url: 'http://localhost:3001/api/protected/income/deleteTransaction/'+id,
          headers: {
            'Authorization': localStorage.getItem('jwt'),
          },
        }).then(res => {
