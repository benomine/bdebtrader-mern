...
import { Modal, Button, Dropdown, ButtonGroup, DropdownButton} from 'react-bootstrap';
...
export default function EditModal(props) {
    ...
    const onSubmit = async (e) => {
        try {
            ...
            await Axios({
                method: 'put',
                url: 'http://localhost:3001/api/protected/income/editTransaction/'+props.transaction._id,
                headers: {
